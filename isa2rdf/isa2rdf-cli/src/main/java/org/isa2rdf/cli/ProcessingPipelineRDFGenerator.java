...
import org.isaagents.isatab.mapping.AssayGroup;
...
public class ProcessingPipelineRDFGenerator<NODE extends Identifiable>  extends RDFGenerator<NODE,Model>{
	...
	public Model createGraph () throws Exception {
        ...
        for (Identifiable c : store.values(org.isaagents.isatab.mapping.AssayGroup.class)) {
	...
	//http://biboagents.googlecode.com/svn/bibo-ontology/trunk/doc/index.html
